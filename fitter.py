...
class Fitter(object):
    ...
    def hist(self):
        ...
        """
        _ = pylab.hist(self._data, bins=self.bins, density=self._density, lw = 0.1, edgecolor = 'b')
        pylab.grid(True)
    ...
    def plot_pdf(self, names=None, Nbest=5, lw=1.5, method="sumsquare_error"):
        ...
        if isinstance(names, list):
            ...
            try:
                ...
                ## I am changing this code here so that I always have the same colors for the same distributions ##
                names = self.df_errors.index[0:Nbest]
            except Exception:
                ## I am changing this code here so that I always have the same colors for the same distributions ##
                names = self.df_errors.index[0:Nbest]
    ...
    def summary(self, Nbest=5, lw=1.5, plot=True, method="sumsquare_error", clf=True):
