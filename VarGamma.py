...
# =======================================================================================
#
# Functions of the module: (with the logpdf added by nurky17)
#
# (log)pdf(x=0.0, c=0.0, sigma=1.0, theta=0.0, nu=1.0)
...
## newly added to this file by nurky17 ##
def logpdf(x=0.0, c=0.0, sigma=1.0, theta=0.0, nu=1.0):
    ''' VarGamma probability density function of an array or a point x '''
    return log(pdf(x, c, sigma, theta, nu)).tolist()
